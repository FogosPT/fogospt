...
## Nota técnica de branch

Esta branch foi reconstruída de forma limpa a partir de `ddc6c76` para evitar erros de `Binary files are not supported` no update branch.
