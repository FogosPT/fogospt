...
return [
    ...
    'information' => [
        ...
        'satellitePerimeter' => [
            ...
            'intro' => 'En la página de cada incidente aparece, al final, un mapa con dos productos derivados de satélite proporcionados por <a href="https://foco.vost.pt" target="_blank" rel="noopener">FOCO</a> (Fire Observation and Characterisation Observatory, de VOST Portugal): el <strong>perímetro</strong> actual del fuego y una <strong>simulación de propagación para las próximas 6 horas</strong>. El producto del satélite Meteosat Third Generation (MTG) se genera cada 10 minutos; el bloque solo aparece cuando hay dato satélite asociado a esa incidencia.',
            'perimeter' => [
                'title' => 'Perímetro (polígono rojo)',
                'description' => 'Traza el área que los satélites Meteosat Third Generation (MTG) están viendo con energía radiada suficiente. Cada píxel del satélite tiene 2 a 4 km de ancho sobre Portugal; FOCO agrupa las detecciones FRP (Fire Radiative Power — potencia radiativa del fuego, en megavatios) de las últimas pasadas y dibuja un polígono. <strong>No es</strong> el área quemada oficial del ICNF (elaborada a posteriori); es una visión en tiempo casi real de dónde el fuego está liberando energía ahora.',
            ],
            'simulation' => [
                'title' => 'Propagación (isócronas +1 h a +6 h)',
                'description' => 'Las curvas concéntricas muestran hasta dónde podría avanzar el fuego en cada una de las próximas 6 horas, hora a hora. Es una simulación de tiempo mínimo de viaje (algoritmo de Dijkstra sobre una malla de 100 m) que combina: la tasa de propagación de referencia calibrada para Portugal (PyroCast), el efecto del viento previsto por el IPMA (multiplicador exponencial direccional que acelera la cabeza del fuego y frena los flancos), la pendiente del terreno (Copernicus GLO-90 DEM — la velocidad duplica aproximadamente cada 10° de subida, según la ley empírica de McArthur), y la humedad del combustible vegetal (el DFMC de los combustibles finos muertos es el factor dominante; por encima de ≈30% el fuego apenas progresa). En el mapa, las isócronas aparecen animadas.',
            ],
            'use' => [
                'title' => 'Para qué sirve',
                'description' => 'Es información de apoyo situacional. El perímetro ayuda a percibir la dimensión real de lo que está ardiendo en el momento; la simulación ayuda a anticipar lo que queda en la trayectoria — aldeas, carreteras, infraestructuras — en las próximas horas. El bloque también trae la lista de municipios y parroquias afectados, calculada por intersección espacial con la CAOP 2025 de la DGT. El sello bajo el título indica la hora de la última pasada satélite procesada.',
            ],
            'limits' => [
                'title' => 'Complementa pero no sustituye — limitaciones importantes',
                'description' => 'FOCO <strong>no es un detector de fuegos nacientes</strong>: un incendio de 1 o 2 hectáreas rara vez alcanza el umbral de energía (50–100 MW) que el satélite necesita para "verlo". Solo cuando el fuego escapa al ataque inicial y crece suele aparecer en el MTG. En resumen: <em>fogos.pt detecta el despacho</em> (el fuego puede aún ser pequeño); <em>FOCO detecta la energía real irradiada</em> — son complementarios. La simulación es un envelope heurístico, no una previsión: no modela proyección de pavesas (spotting), supresión activa ni piroconvección; asume el viento previsto y, si cambia bruscamente o pasa un frente, la evolución real puede alejarse del escenario. Los fuegos mayoritariamente del lado español de la frontera aparecen como "Fuera de la cobertura de la simulación", porque las capas de combustible cubren solo el continente portugués. Estos productos <strong>nunca sustituyen</strong> la información oficial de la ANEPC, IPMA o ICNF.',
            ],
            'source' => 'Datos proporcionados por <a href="https://foco.vost.pt" target="_blank" rel="noopener">FOCO — VOST Portugal</a>, a partir del producto MTG MTFRPPixel del LSA SAF (EUMETSAT, alojado en el IPMA), PyroCast (VOST) para tasa de propagación y humedad del combustible, COS2023 (DGT) para cobertura del suelo y carga de combustible, Copernicus GLO-90 DEM para el relieve, y CAOP 2025 (DGT) para los límites administrativos de municipios y parroquias.',
        ],
        'ipmaCharts' => [
